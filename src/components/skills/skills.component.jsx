...
function Skills() {
  ...
  const textReact = "When it comes to my first superpower, it is React! I love the way of simplicity in React.js. All paradigms of React and how it behaves when it comes to render components are known to me. All extra features/packages like Redux, ContextAPI, styled-components, HOC, routing, Redux-Saga, React Hooks...I just love it and freedom of choosing tools when it comes to build/solve interfaces/problems."
  const textSASS = "As my second superpower I would say something about Sass. The way that Sass simplify things in CSS is just asthonishing. All it's features like mixins, variables, imports, nesting classes are just tools that I can't imagine living without right now."
  ...
  return (
    <section className="skills">
      ...
      <div className="skills-container">
        ...
        <SkillCart skill={'SASS'} heading={'SASS'} text={textSASS}/>
