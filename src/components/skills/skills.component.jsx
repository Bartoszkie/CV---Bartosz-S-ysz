...
function Skills() {
  const textJS =
    "So, when it comes to JS I feel very comofrtable with it. All fundamentals about JS are familiar to me. Both ES5 and ES6+ features are not scary to me - BTW I love ES6!";
  const textCSS =
    "I love positioning. I think I know tons of new features of CSS and I feel very familiar with every new paradigms of positioning like FlexBox and CSS Grid - and also those old ones like Floats aren't unfamiliar to me!.";
  const textHTML =
    "Yeah I even know how to program in HTML... of course it is a joke! There are tons of blocks that are known to me. I know how and when to use them, what are advantages and disatvantages of one above the other, and I'm always trying to write web skeleton as simple as it is possible.";
  const textReact =
